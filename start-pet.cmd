@echo off
rem Launcher for the whale balance pet (small window pinned to the screen corner).
...
setlocal
cd /d "%~dp0"
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0tools\start.ps1" -Mode pet
endlocal
